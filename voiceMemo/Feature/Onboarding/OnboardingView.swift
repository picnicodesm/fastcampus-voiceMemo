...
private struct OnboardingContentView: View {
    ...
    fileprivate var body: some View {
        VStack {
            OnboardingCelListView(onboardingViewModel: onboardingViewModel)
            
            Spacer()
            
            StartBtnView()
        }
        .edgesIgnoringSafeArea(.top) // dep
    }
}

// MARK: - 온보딩 셀 리스트 뷰
private struct OnboardingCelListView: View {
    @ObservedObject private var onboardingViewModel: OnboardingViewModel
            ...
            label: {
                HStack {
                    Text("시작하기")
                        ...
                        .foregroundColor(.customGreen) // dep
